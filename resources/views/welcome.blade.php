...
<main>
  ...
  <div class="container marketing">
    ...
    <div class="row">
      ...
      <div class="col-lg-4">
        <img class="bd-placeholder-img rounded-circle" width="140" height="140" src="https://i0.wp.com/eymmusicperu.com/wp-content/uploads/2020/09/trumpet.jpg?fit=800%2C527&ssl=1" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#777"/><text x="50%" y="50%" fill="#777" dy=".3em"></text></svg>
    ...
    <div class="row featurette">
      ...
      <div class="col-md-5">
        <image src="https://assets.classicfm.com/2017/01/piano-v4r-1483624599-editorial-short-form-0.jpg" height="500" width="500"/>
